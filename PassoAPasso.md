...
- Provisionar banco Postgres
  - Resources, Add-on - Heroku Postgree
- Definir variável APP_PROFILE=prod
  - Setting - Config Vars - Key: APP_PROFILE | Value: prod
- Conectar ao banco via pgAdmin
  - Copiar o value do do DATABASE_URL do Heroku
    - Host: após o @ copie até .amazonaws.com 
    - Nome do BD: de trás pra frente, até a /
    - Usuário: entre postgres:// e os :
    - Senha: entre os : e o @
    
  - Criar seed do banco
  - No pgAdmin, Botão direito em servers - create - server
    - Em Connection, coloque o host, Nome do BD(Maintance db), Usuário e Senha copiados do Heroku
    - Em Advanced, DB resriction, coloque o nome da DB - Como é plano gratuito, e ele compartilha varias DB no msm server, se n colocar o nome ele compartilha milhares de DB, sendo dificil de localizar o seu.
    - Na DB criada - schemas - public - botão direito - create query tool
    - Colar o conteúdo do arq .sql 


```bash
heroku -v
heroku login
heroku git:remote -a <nome-do-app-do-heroku>
git remote -v
git subtree push --prefix <nome da pasta local, no caso backend> heroku main
```

- No Postman, alterar a URL do current value do ambiente para a URL do Heroku
